...
class GeoIPResolver:
    ...
    def __init__(
        ...
        # live anywhere, not just at this CWD-relative default. Mirrors
        # the STEALTH_BROWSER_PATH convention used for the browser binary,
        # the same class of "real file this repo can't ship" problem.
